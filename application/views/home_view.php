            ...
            <div class="col-md-6">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-fw fa-check"></i>Online TA</h4>
                    </div>
                    <div class="panel-body">
                        <p>Our story. OnlineTA is designed to connect students, TAs, and professors so every student can get the help they need when they need it. Today, hundreds of thousands of students across hundreds of campuses are using OnlineTA for their classes</p>
